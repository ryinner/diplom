...
class GHousesSeeder extends AbstractSeed
{
    /**
     * Run Method.
     *
    ...
    public function run()
    {
        $data = [
            ...
            [
                'description' => '<p>Благодаря монолитно-каркасной конструкции дома, по согласованию с надзорными органами, в квартире можно безопасно выполнять перепланировку.</p>
